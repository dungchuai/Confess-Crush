const CONFIG = {
    ...
    reply: 'A',
    mess: 'em tạo web này để tỏ tình nhưng mà em sẽ không nhận được câu trả lời vì em mới học lập trình à',
    messDesc: 'chị có thể trả lời qua tin nhắn fb giúp em với ạ :<',
